...
const config = {
  title: 'Introduction to Computer Systems (Section - N)',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/FahimFBA/ICS-N-Fall2024',
            label: 'GitHub',
            position: 'right',
          },
        ],
